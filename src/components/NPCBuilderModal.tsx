...
- relationships: Danh sách các tương quan (Mảng object [{name, relation, status, impression, termsOfAddress, selfAppellation, description}]). (NGUYÊN TẮC: TUYỆT ĐỐI KHÔNG TẠO QUAN HỆ VỚI KHÁCH THỂ CHƯA XUẤT HIỆN. Để trống mảng nếu không quen ai. Tên npc phải ghi đầy đủ họ tên. ĐẶC BIỆT: Khi tạo mối quan hệ, BẮT BUỘC phải điền đầy đủ nội dung cho "impression" (Ấn tượng và suy nghĩ chi tiết về đối phương), "termsOfAddress" (Mảng các cách xưng hô thường dùng với đối phương, VD [" huynh", " đại ca"]), và "selfAppellation" (Mảng các cách tự xưng bản thân với đối phương, VD [" muội", " tiểu đệ"]). NGHIÊM CẤM lười biếng bỏ trống các mục này!).
      ...
      if (match && match[1]) {
        ...
        if (unclosedMatch && unclosedMatch[1]) {
          ...
          if (
            ...
            cleanedJsonStr = cleanedJsonStr.substring(
              firstBrace,
              lastBrace + 1,
            );
          }
